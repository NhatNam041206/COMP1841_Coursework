<form action="" method="post" class="add-question-form">
    ...
    <div class="form-row">
        ...
        <div class="form-field">
            ...
            <input type="date" name="questiondate" id="questiondate" value="<?= htmlspecialchars($question['questiondate'], ENT_QUOTES, 'UTF-8') ?>" required>
        </div>

        <div class="form-field">
            <label for="questionimage">Type image file name:</label>
            <input type="text" name="questionimage" id="questionimage" value="<?= htmlspecialchars($question['questionimage'], ENT_QUOTES, 'UTF-8') ?>" required>
        </div>

        <div class="form-field">
            <label for="questiondocument">Type document file name:</label>
            <input type="text" name="questiondocument" id="questiondocument" value="<?= htmlspecialchars($question['questiondocument'], ENT_QUOTES, 'UTF-8') ?>">
        </div>
    </div>
